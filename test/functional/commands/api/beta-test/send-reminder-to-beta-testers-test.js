...
describe('Functional test - ask api send-reminder-to-beta-testers', () => {
    const operation = 'send-reminder-to-beta-testers';
    ...
    const SEND_REMINDER_TO_BETA_TESTERS_SUCCESS_MESSAGE = 'Reminders sent to beta testers successfully.';
    const VALID_FILE_EXTENSION_TYPE = '.csv';
    const EMPTY_BODY = {};

    // request options test object for traverse mode
    function createSendReminderToBetaTestersRequestOptions() {
        const url = `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V1}/skills/${TEST_SKILL_ID}/betaTest/testers/sendReminder`;
