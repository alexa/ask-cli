...
describe('Functional test - ask api end-beta-test', () => {
    const operation = 'end-beta-test';
    ...
    const END_BETA_TEST_COMMAND = `ask api ${operation}`;
    const EMPTY_BODY = {};
    const END_BETA_TEST_SUCCESS_MESSAGE = 'Beta test ended successfully';
    ...
    function getEndBetaTestRequestOptions() {
        return {
            url: `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/betaTest/end`,
