...
describe('Functional test - ask api add-private-distribution-account', () => {
    const operation = 'add-private-distribution-account';
    ...
    const AddPrivateDistributionAccountRequestOptions = {
    ...
    [
        ...
        },
        {
            ...
            httpMockConfig: [{
                input: [AddPrivateDistributionAccountRequestOptions, operation],
