...
const AbstractBuildFlow = require("../../../../lib/builtins/build-flows/abstract-build-flow");
const PythonPipBuildFlow = require("../../../../lib/builtins/build-flows/python-pip");
    ...
    it("| should throw error when python 2 is used", (done) => {
      ...
      buildFlow.execute((err, res) => {
        expect(err.message).eql(
          "Current python (2.7.2) is not supported. " +
