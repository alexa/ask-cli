...
const {camelCase, standardize} = require("../../../../lib/utils/string-utils");
const CliError = require("../../../../lib/exceptions/cli-error");
const {customizationMap} = require("../../../../lib/commands/smapi/customizations/parameters-map");
const {
  CliCustomizationProcessor,
  BODY_PATH_DELIMITER,
  MAX_NESTED_PROPERTIES,
} = require("../../../../lib/commands/smapi/cli-customization-processor");
...
describe("Smapi test - CliCustomizationProcessor class", () => {
  ...
  beforeEach(() => {
    ...
    definitions = new Map([
      ...
      ["SomeNestedType", {required: [nestedPropertyName], properties: {nestedProperty}}],
      ["SomeTooManyPropertiesType", {properties: {...objectWithTooManyProperties}}],
      ["SomeTooNestedType", {properties: {test: {$ref: "SomeNestedType"}}}],
      ["SomeNestedEnumType", {required: [nestedPropertyName], description: refObjectDescription, properties: {nestedEnumProperty}}],
    ]);
  });
