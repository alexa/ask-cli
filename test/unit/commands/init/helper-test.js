...
const helper = require("../../../../lib/commands/init/helper");
const ui = require("../../../../lib/commands/init/ui");
    ...
    it("| pre init check and overwrite confirmation returns false", (done) => {
      ...
      helper.preInitCheck(TEST_ROOT, TEST_PROFILE, (err, res) => {
        ...
        expect(err.message).equal(
          `Please modify the existing ${CONSTANTS.FILE_PATH.ASK_RESOURCES_JSON_CONFIG} file or choose to overwrite.`,
        );
