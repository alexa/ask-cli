...
describe('Model test - dialog output file test', () => {
    ...
    it('| should write dialog history to a file', () => {
        const dialogOutputFile = new DialogOutputFile(outputFilePath);
        ...
        expect(dialogOutputFile).to.be.instanceof(DialogOutputFile);
    ...
    it('| should not write to file if no output path provided', () => {
        const dialogOutputFile = new DialogOutputFile();
