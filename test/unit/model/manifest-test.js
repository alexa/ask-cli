...
describe("Model test - manifest file test", () => {
  ...
  describe("# inspect correctness for getter and setter for different fields", () => {
    ...
    [
      {
        ...
        oldValue: {
          "de-DE": {
            ...
            examplePhrases: ["This is good", "no icon"],
            name: "skillName de",
            description: "skill description",
          },
          "en-US": {
            summary: "Sample Short Description",
            examplePhrases: ["Alexa open hello world", "Alexa tell hello world hello", "Alexa ask hello world say hello"],
            name: "skillName us",
            description: "Sample Full Description",
          },
          "ja-JP": {
            summary: "coniqiwa",
            examplePhrases: ["More to come", "coniqiwa"],
            name: "skillName jp",
    ...
    ].forEach(({field, input, newValue, oldValue}) => {
