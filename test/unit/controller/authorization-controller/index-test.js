...
const LWAClient = require("../../../../lib/clients/lwa-auth-code-client");
const AuthorizationController = require("../../../../lib/controllers/authorization-controller");
const messages = require("../../../../lib/controllers/authorization-controller/messages");
...
describe("Controller test - Authorization controller test", () => {
  ...
  describe("# test tokenRefreshAndRead", () => {
    ...
    describe("# returns valid token", () => {
      it("| non-environment profile, expired access token", (done) => {
        ...
        sinon
          .stub(AuthorizationController.prototype, "_getRefreshTokenAndUpdateConfig")
  ...
  describe("# test getTokensByListeningOnPort", () => {
    ...
    beforeEach(() => {
      ...
      openStub = sinon.stub();
      proxyHelper = proxyquire("../../../../lib/controllers/authorization-controller", {
        open: openStub,
      });
    });
