    ...
    [
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V1}` +
      ...
      },
      {
        ...
        parameters: [
          TEST_SKILL_ID,
          TEST_SINGLE_KEYWORD,
          TEST_PROVIDER_SKILL_ID,
          {maxResults: TEST_MAX_RESULTS, nextToken: TEST_NEXT_TOKEN},
          noop,
        ],
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V1}/tasks/?` +
            `maxResults=${TEST_MAX_RESULTS}&nextToken=${TEST_NEXT_TOKEN}&` +
      ...
      },
      {
        ...
        parameters: [
          TEST_SKILL_ID,
          TEST_MULTIPLE_KEYWORDS_INCLUDING_SPACES,
          TEST_PROVIDER_SKILL_ID,
          {maxResults: TEST_MAX_RESULTS, nextToken: TEST_NEXT_TOKEN},
          noop,
        ],
