  ...
  describe("# smapi client isp APIs", () => {
    ...
    [
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/stages/${TEST_ISP_STAGE}/inSkillProducts?` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/inSkillProducts?nextToken=${TEST_NEXT_TOKEN}&maxResults=${TEST_MAX_RESULTS}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/inSkillProducts?productId=id1&productId=id2&vendorId=${TEST_VENDOR_ID}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/inSkillProducts/${TEST_ISP_ID}/stages/${TEST_ISP_STAGE}/skills?` +
            `nextToken=${TEST_NEXT_TOKEN}&maxResults=${TEST_MAX_RESULTS}`,
          method: CONSTANTS.HTTP_REQUEST.VERB.GET,
          headers: {
            authorization: TEST_ACCESS_TOKEN,
