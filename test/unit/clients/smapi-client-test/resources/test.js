...
module.exports = (smapiClient) => {
  describe("# skill test related APIs", () => {
    ...
    const TEST_MODIFY_TURN_PAYLOAD = "modifyturnPayload";
    ...
    [
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V2}/skills/${TEST_SKILL_ID}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V2}/skills/${TEST_SKILL_ID}/stages/` +
      ...
      {
        testCase: "modify-last-turn",
        apiFunc: smapiClient.skill.test.modifyLastTurn,
        parameters: [
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/${CONSTANTS.SMAPI.VERSION.V1}/skills/${TEST_SKILL_ID}/stages/` +
            `${CONSTANTS.SKILL.STAGE.DEVELOPMENT}/locales/en_us/conversations/turnPredictions`,
          method: CONSTANTS.HTTP_REQUEST.VERB.PUT,
          headers: {
            authorization: TEST_ACCESS_TOKEN,
          },
          body: TEST_MODIFY_TURN_PAYLOAD,
          json: true,
        },
      },
