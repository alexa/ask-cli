  ...
  describe("# skill publishing lifecycle related APIs", () => {
    ...
    [
      ...
      },
      {
        ...
        parameters: [TEST_SKILL_ID, {nextToken: TEST_NEXT_TOKEN, maxResults: TEST_MAX_RESULTS}, noop],
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/certifications?` +
      ...
      },
      {
        ...
        expectedOptions: {
          url: `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/certifications?` + `nextToken=${TEST_NEXT_TOKEN}`,
          method: CONSTANTS.HTTP_REQUEST.VERB.GET,
          headers: {
            authorization: TEST_ACCESS_TOKEN,
          },
      ...
      },
      {
        ...
        expectedOptions: {
          url: `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/certifications?` + `maxResults=${TEST_MAX_RESULTS}`,
          method: CONSTANTS.HTTP_REQUEST.VERB.GET,
          headers: {
            authorization: TEST_ACCESS_TOKEN,
          },
