  ...
  describe("# skill CRUD related APIs", () => {
    ...
    [
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills?nextToken=${TEST_NEXT_TOKEN}&` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/status?resource=${CONSTANTS.SKILL.RESOURCES.MANIFEST}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/stages/${TEST_SKILL_STAGE}/inSkillProducts?` +
  ...
  describe("# skill development lifecycle related APIs", () => {
    ...
    [
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/metrics?startTime=${TEST_START_TIME}&endTime=${TEST_END_TIME}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/metrics?endTime=${TEST_END_TIME}&period=${TEST_PERIOD}` +
      ...
      },
      {
        ...
        expectedOptions: {
          url:
            `${CONSTANTS.SMAPI.ENDPOINT}/v1/skills/${TEST_SKILL_ID}/metrics?startTime=${TEST_START_TIME}&period=${TEST_PERIOD}` +
            `&metric=${TEST_METRIC}&stage=${TEST_SKILL_STAGE}&skillType=${TEST_SKILL_TYPE}&intent=${TEST_INTENT}&locale=${TEST_LOCALE}` +
            `&maxResults=${TEST_MAX_RESULTS}&nextToken=${TEST_NEXT_TOKEN}`,
          method: CONSTANTS.HTTP_REQUEST.VERB.GET,
          headers: {
