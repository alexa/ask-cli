...
const CloudformationClient = require("../../../../lib/clients/aws-client/cloudformation-client");
...
describe("Clients test - cloudformation client test", () => {
  ...
  let createStackStub, updateStackStub, describeStackStub, describeStackResourceStub, describeStackResourcesStub;
