...
const S3Client = require("../../../../lib/clients/aws-client/s3-client");
...
describe("Clients test - s3 client test", () => {
  ...
  describe("# function preSignedPutObject tests", () => {
    ...
    beforeEach(() => {
      ...
      proxyClient = proxyquire("../../../../lib/clients/aws-client/s3-client", {
        request: stubRequest,
      });
    });
  ...
  describe("# function waitForBucketExists tests", () => {
    ...
    it("| s3Client waitfor bucketExists event and s3client request pass, expect callback response", (done) => {
      ...
      sinon
        .stub(s3Client.client, "waitFor")
        .withArgs("bucketExists", expectedParams, sinon.match.func)
        .callsArgWith(2, null, TEST_RESPONSE);
      // call
      s3Client.waitForBucketExists(TEST_BUCKET_NAME, (error, response) => {
        // verify
        expect(error).equal(null);
  ...
  describe.skip("# function putBucketVersioning tests", () => {
    it(
      "| s3Client putBucketVersioning method correctly pass params to S3 putBucketVersioning method, " +
        "and callback error when S3 pubBucketVersioning callback error",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        ...
        sinon
          .stub(s3Client.client, "putBucketVersioning")
          .withArgs(expectedParams, sinon.match.func)
          .callsArgWith(1, TEST_PUTVERSION_ERROR);
        // call
    ...
    it(
      "| s3Client putBucketVersioning method can correctly pass params to aws S3 putBucketVersioning method, " +
        "and callback response when S3 putBucketVersioning is executed correctly",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
  ...
  describe("# function createBucket tests", () => {
    it(
      "| s3Client createBucket method can correctly pass params to aws S3 createBucket method when region is us-east-1, " +
        "and callback error when S3 createBucket callback error",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
    ...
    it(
      "| s3Client createBucket method can correctly pass params to aws S3 createBucket method when region is not us-east-1," +
        " and callback response when S3 createBucket is executed correctly",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
  ...
  describe("# function headBucket tests", () => {
    it(
      "| s3Client headBucket method can correctly pass params to aws S3 headBucket method, " +
        "and callback error when S3 headBucket callback error",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
    ...
    it(
      "| s3Client headBucket method can correctly pass params to aws S3 headBucket method, " +
        "and callback response when S3  headBucket is executed correctly",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
  ...
  describe.skip("# function getBucketVersioning tests", () => {
    it(
      "| s3Client getBucketVersioning method, can correctly pass params to aws S3 getBucketVersioning method, " +
        "and callback error when S3  getBucketVersioning callback error ",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
        ...
        sinon
          .stub(s3Client.client, "getBucketVersioning")
          .withArgs(expectedParams, sinon.match.func)
          .callsArgWith(1, TEST_GETVERSION_ERROR);
        // call
    ...
    it(
      "| s3Client getBucketVersioning method, can correctly pass params to aws S3 getBucketVersioning method, " +
        "and callback response when S3  getBucketVersioning is executed correctly",
      (done) => {
        // setup
        const s3Client = new S3Client(TEST_CONFIGURATION);
        const expectedParams = {
