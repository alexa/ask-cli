...
module.exports = class SkillSimulationController {
    ...
    constructor(configuration) {
        ...
        this.locale = locale;
        this.stage = stage;
        this.dialogSaveSkillIoInstance = new DialogSaveSkillIoFile(saveSkillIo);
    }
    ...
    startSkillSimulation(utterance, newSession, callback) {
        this.dialogSaveSkillIoInstance.startInvocation({ utterance, newSession });
    ...
    getSkillSimulationResult(simulationId, callback) {
        ...
        Retry.retry(retryConfig, retryCall, shouldRetryCondition, (err, res) => {
            ...
            this.dialogSaveSkillIoInstance.endInvocation({ body: res.body });
            if (!res.body.status) {
