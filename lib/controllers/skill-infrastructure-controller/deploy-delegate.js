...
const BUILT_IN_DEPLOY_DELEGATES = {
    [CONSTANTS.DEPLOYER_TYPE.CFN.NAME]: {
        ...
        templates: {
            branch: 'ask-cli-x',
            language_map: {
                NodeJS: 'https://ask-cli-static-content.s3-us-west-2.amazonaws.com/skill-templates/nodejs-templates.json',
                Python: 'https://ask-cli-static-content.s3-us-west-2.amazonaws.com/skill-templates/python-templates.json',
                Java: 'https://ask-cli-static-content.s3-us-west-2.amazonaws.com/skill-templates/java-templates.json'
            }
        }
    },
