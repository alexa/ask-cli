...
const CustomBuildFlow = require("../../builtins/build-flows/custom");
const JavaMvnBuildFlow = require("../../builtins/build-flows/java-mvn");
const NodeJsNpmBuildFlow = require("../../builtins/build-flows/nodejs-npm");
const PythonPipBuildFlow = require("../../builtins/build-flows/python-pip");
const ZipOnlyBuildFlow = require("../../builtins/build-flows/zip-only");

// order is important
const BUILD_FLOWS = [CustomBuildFlow, NodeJsNpmBuildFlow, JavaMvnBuildFlow, PythonPipBuildFlow, ZipOnlyBuildFlow];
