...
function _updateAskResources(projectPath, skillId, metadata, profile) {
    ...
    ResourcesConfig.getInstance().setSkillInfraDeployState(profile, metadata);
 ...
 */
function cloneProjectFromGit(projectPath, skillName, profile, doDebug) {
...
function _makeBranchesVisible(gitClient) {
    const branchesToCheckout = ['master', 'prod', 'dev'];
