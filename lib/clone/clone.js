        ...
        function handle(options) {
            if (options.skillId) {
                cloneSkill.getSkill(options.skillId, options.stage, (skillSchema) => {
                    ...
                    cloneProject.clone(projectPath, options.skillId, skillName, skillInfo);

                    cloneSkill.clone(projectPath, skillSchema, options.skillId, skillName,
                        skillInfo, localeList, (lambdaPath, skillInfo) => {
                        cloneLambda.clone(lambdaPath, skillInfo);
                    });
                });
            } else {
