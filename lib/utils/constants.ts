...
export const APPLICATION_NAME = 'ask-cli';
export const NPM_REGISTRY_URL_BASE = 'http://registry.npmjs.org';

export const METRICS = {
    ENDPOINT: 'https://client-telemetry.amazonalexa.com'
};

export const DEPLOYER_TYPE = {
    HOSTED: {
...
export const AWS_SKILL_INFRASTRUCTURE_DEFAULT_REGION = 'us-east-1';
...
export const ASK_DEFAULT_PROFILE_NAME = 'default';
export const AWS_DEFAULT_PROFILE_NAME = 'ask_cli_default';
