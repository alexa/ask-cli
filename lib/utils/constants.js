...
module.exports.HOSTED_SKILL = {
    ...
    S3_SCRIPTS: {
        AUTH_INFO: {
            URL: 'https://s3-script-upload-test.s3-us-west-2.amazonaws.com/auth_info'
        },
        PRE_PUSH: {
            URL: 'https://s3-script-upload-test.s3-us-west-2.amazonaws.com/git-hooks-templates/pro/pre-push'
        },
        ASK_PRE_PUSH: {
            URL: 'https://s3-script-upload-test.s3-us-west-2.amazonaws.com/git-hooks-templates/pro/ask-pre-push',
        },
        GIT_CREDENTIAL_HELPER: {
            URL: 'https://s3-script-upload-test.s3-us-west-2.amazonaws.com/helper/git-credential-helper',
        }
    },
    HIDDEN_GIT_FOLDER: {
        NAME: '.git',
