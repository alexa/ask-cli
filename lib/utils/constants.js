...
module.exports.HOSTED_SKILL = {
    ...
    S3_SCRIPTS: {
        AUTH_INFO: {
            URL: 'https://ask-tools-content-test.s3-us-west-2.amazonaws.com/auth_info'
        },
        PRE_PUSH: {
            URL: 'https://ask-tools-content-test.s3-us-west-2.amazonaws.com/pre-push'
        },
        ASK_PRE_PUSH: {
            URL: 'https://ask-tools-content-test.s3-us-west-2.amazonaws.com/ask-pre-push',
        },
        GIT_CREDENTIAL_HELPER: {
            URL: 'https://ask-tools-content-test.s3-us-west-2.amazonaws.com/git-credential-helper',
        }
    },
    HIDDEN_GIT_FOLDER: {
        NAME: '.git',
