...
module.exports.ASK_CLI_RESOURCES_VERSION = '2019-08-23';
...
module.exports.DEPLOYER_TYPE = {
    HOSTED: {
        ...
        DESCRIPTION: 'Deploy skill infrastructure by creating an Alexa hosted skill, '
        + 'and cloning the skill project to local machine.'
    },
    CFN: {
