...
module.exports.DEPLOYER_TYPE = {
  ...
  SELF_HOSTED: {
    OPTION_NAME: "Self-hosted",
    NAME: "self-hosted-skill-deployer",
    DESCRIPTION: "Manage your own hosting",
  },
};
...
module.exports.HOSTED_SKILL = {
  ...
  RUN: {
    INVOCATION_INFO: {
      node: {skillCodeFolderName: "lambda", handlerName: "handler", skillFileName: "index"},
      python: {
...
module.exports.CONFIGURATION = {
  ...
  RETRY: {
    ...
    GET_PACKAGE_IMPORT_STATUS_FOR_AC: {
      MAX_RETRY: 75,
      MIN_TIME_OUT: 2000,
      FACTOR: 1.12,
    },
...
module.exports.TEMPLATES = {
  TEMPLATE_S3_SOURCE_URL: "https://ask-cli-static-content.s3.us-west-2.amazonaws.com/skill-templates/templates.json",
  TEMPLATE_DEFAULT_BRANCH_NAME: "ask-cli-x",
  INTERACTION_MODEL_MAP:
    "https://ask-cli-static-content.s3-us-west-2.amazonaws.com/interaction-model-templates/interaction-model-templates.json",
};
  ...
  IAM: {
    USER: {
      ...
      POLICY_ARN: {
        ...
        CLOUD_WATCH_FULL: "arn:aws:iam::aws:policy/CloudWatchLogsFullAccess",
      },
    },
    ROLE: {
      LAMBDA_BASIC_ROLE: {
...
module.exports.LAMBDA = {
  ...
  ERROR_MESSAGE: {
    ROLE_NOT_ASSUMED: "The role defined for the function cannot be assumed by Lambda.",
  },
  FUNCTION_STATE: {
    ACTIVE: "Active",
    INACTIVE: "Inactive",
...
module.exports.SMAPI = {
  ...
  API_NAME: {
    ...
    MODIFY_LAST_TURN: "modify-last-turn",
...
const DEFAULT_PUBLIC_SCOPES =
  `${SCOPES_SKILLS_READWRITE} ${SCOPES_MODELS_READWRITE} ${SCOPES_SKILLS_TEST} ${SCOPES_CATALOG_READ}` +
...
module.exports.COMPILER = {
  ASK_COMPILER: "ask-compiler",
  ASK_DECOMPILER: "ask-decompiler",
  ACDL_PATH: "conversations",
  TARGETDIR: "skill-package",
  MANIFEST: "skill.json",
};

module.exports.DEPLOYMENT_TYPE = {
  ALEXA_CONVERSATIONS: "alexa-conversations",
  INTERACTION_MODEL: "interaction-model",
};

module.exports.TEN_MEGA_BYTES = 1000 * 1000 * 10;

module.exports.GIT_USAGE_HOSTED_SKILL_DOCUMENTATION =
  "https://developer.amazon.com/en-US/docs/alexa/hosted-skills/alexa-hosted-skills-ask-cli.html";

module.exports.ACDL_BETA_MESSAGE =
  "Alexa Conversations Description Language is currently in beta and may have breaking changes before it reaches General Availability. Please report any bugs or issues on GitHub: https://github.com/alexa/ask-cli/issues";
