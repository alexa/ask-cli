...
module.exports.TEMPLATES = {
    ...
    INTERACTION_MODEL_MAP: 'https://ask-cli-static-content.s3-us-west-2.amazonaws.com/interaction-model-templates/interaction-model-templates.json'
};
...
module.exports.COMPILER = {
    /**
     * Root directory name (not path) to let compiler know where is the Skill Package source.
     * This is now different from skillMetadata.src in ask-resources.json
     * Because now, there are two concepts - 1. source 2. compiled output a.k.a. deployable package
     * skillMetadata.src represents the #2. 
     * Hence, we need this for the #1.
     */
    ROOTDIR: "skill-package",
    SKILL_PACKAGE: {
        /**
         * Root of the conversations ACDL src files.
         */
        CONVERSATIONS: "conversations",
        /**
         * Compiler output directory name (not path) within skill package.
         */
        OUTDIR: "build"
    }
}
...
module.exports.DECOMPILER = {
    /**
     * Root directory name (not path) to let decompiler know where is the Skill Package source.
     * This is now different from skillMetadata.src in ask-resources.json
     * Because now, there are two concepts - 1. source 2. decompiled output a.k.a. acdl files
     */
    ROOTDIR: "skill-package",
    SKILL_PACKAGE: {
        /**
         * Decompiler output directory name (not path) within skill package.
         */
        OUTDIR: "conversations"
    }
}
...
module.exports.SYNTHESIZE = {
    ...
    CONVERSATIONS: "conversations",
    /**
     * Root of the skill package generated (a temporary deployable artifact).
     */
