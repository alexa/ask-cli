...
class DynamicConfig {
    ...
    static get s3Scripts() {
        const baseUrl = resolve([process.env.ASK_S3_SCRIPTS_BASE_URL, 'https://ask-tools-content-test.s3-us-west-2.amazonaws.com']);
        return {
            authInfo: `${baseUrl}/auth_info`,
            prePush: `${baseUrl}/pre-push`,
            askPrePush: `${baseUrl}/ask-pre-push`,
            gitCredentialHelper: `${baseUrl}/git-credential-helper`,
        };
    }
