import {CliReplView, CliReplViewConfig} from "./cli-repl-view";

export class DialogReplView extends CliReplView {
  /**
   ...
   */
  registerRecordCommand(func: (args: string) => void) {
    this.registerSpecialCommand("record", "Record input utterances to a replay file of a specified name.", func);
  }
}
