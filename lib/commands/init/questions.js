...
module.exports = {
    REQUEST_ASK_PROFILE_NAME: [{
        message: `Please provide a profile name or press enter to use ${CONSTANTS.COMMAND.INIT.ASK_DEFAULT_PROFILE_NAME} as the profile name: `,
        type: 'input',
        name: 'profile',
        default: CONSTANTS.COMMAND.INIT.ASK_DEFAULT_PROFILE_NAME
    }],
    SELECT_VENDOR_ID: [{
        type: 'rawlist',
    ...
    REQUEST_AWS_PROFILE_NAME: existingProfiles => [{
        ...
        default: existingProfiles.includes(CONSTANTS.COMMAND.INIT.AWS_DEFAULT_PROFILE_NAME) ? null : CONSTANTS.COMMAND.INIT.AWS_DEFAULT_PROFILE_NAME,
        validate: (input) => {
