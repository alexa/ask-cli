...
function _getSkillLocale(userInput, callback) {
    ...
    ui.getSkillLocale(CONSTANTS.HOSTED_SKILL.DEFAULT_LOCALE, (err, res) => callback(err || null, res));
}
...
function _getSkillDefaultRegion(userInput, callback) {
    ...
    ui.getSkillDefaultRegion(CONSTANTS.HOSTED_SKILL.DEFAULT_REGION, (err, res) => callback(err || null, res));
}
