...
function getSkillLocale(defaultLocale, callback) {
    inquirer.prompt([{
        message: 'Please type in default locale for the skill (For example: en-GB): ',
        type: 'input',
...
function getSkillDefaultRegion(defaultRegion, callback) {
    inquirer.prompt([{
        message: 'Please type in default region for the skill (For example: us-east-1): ',
        type: 'input',
