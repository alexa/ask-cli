...
function checkIfDevBranchClean(gitClient) {
    ...
    let diffCountWithOrigin = gitClient.countCommitDifference('origin/dev', 'dev');
    diffCountWithOrigin = diffCountWithOrigin.toString().replace(/\D/g, '');
    let diffCountWithMaster = gitClient.countCommitDifference('master', 'dev');
    diffCountWithMaster = diffCountWithMaster.toString().replace(/\D/g, '');
    if ((stringUtils.isNonBlankString(diffCountWithOrigin) && diffCountWithOrigin !== '0')
    || (stringUtils.isNonBlankString(diffCountWithMaster) && diffCountWithMaster !== '0')) {
