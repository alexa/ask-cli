...
operationHooks.set('listCatalogsForVendorV0', new Map([[events.BEFORE_SEND, appendVendorId]]));
...
operationHooks.set('listSubscribersForDevelopmentEventsV0', new Map([[events.BEFORE_SEND, appendVendorId]]));
operationHooks.set('listSubscriptionsForDevelopmentEventsV0', new Map([[events.BEFORE_SEND, appendVendorId]]));
