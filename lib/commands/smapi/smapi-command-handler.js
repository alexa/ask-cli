...
const _makeResultFromLocationHeader = (locationHeader) => {
    ...
    return { ...parameters, statusCheckHintCommand, locationHeaderValue: value };
};
...
const parseSmapiResponse = (response) => {
    ...
    if (statusCode === 202 && locationHeader) {
        result = jsonView.toString(_makeResultFromLocationHeader(locationHeader));
