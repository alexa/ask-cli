...
class DeployCommand extends AbstractCommand {
    ...
    handle(cmd, cb) {
        ...
        try {
            ...
            ui.confirmDeploymentIfNeeded((err, confirmResult) => {
                if(err) {
...
function _deploySkillMetadata(options, callback) {
    ...
    skillMetaSpinner.start('Uploading the entire skill package and building the models. Normally it takes a few minutes and for Alexa Conversations it can take 20-60 minutes...');
