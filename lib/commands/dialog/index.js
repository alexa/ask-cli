...
class DialogCommand extends AbstractCommand {
    ...
    optionalOptions() {
        return ['skill-id', 'locale', 'stage', 'replay', 'output', 'profile', 'debug'];
    }
    ...
    _getDialogConfig(cmd, callback) {
        ...
        smapiClient.skill.manifest.getManifest(skillId, stage, (err, res) => {
            ...
            callback(null, { skillId, locale, stage, profile, debug, replay: cmd.replay, output, smapiClient, userInputs });
        });
    }
