...
module.exports.ASK_SIGN_IN_FAILURE_MESSAGE =
...
module.exports.PROFILE_NAME_VALIDATION_ERROR =
  "Invalid profile name. A profile name can contain upper and lowercase letters, numbers, hyphens, and underscores.";
...
module.exports.VENDOR_ID_CREATE_INSTRUCTIONS =
  "There is no Vendor ID associated with your account. To setup Vendor ID, please follow the instructions here: https://developer.amazon.com/en-US/docs/alexa/smapi/manage-credentials-with-ask-cli.html#vendor-id";

module.exports.AWS_CONFIGURATION_MESSAGE =
...
module.exports.LWA_TOKEN_SHARE_WARN_MESSAGE =
  "ASK CLI uses authorization code to fetch LWA tokens. Do not share neither your authorization code nor access tokens.";

module.exports.AWS_SECRET_ACCESS_KEY_AND_ID_SHARE_WARN_MESSAGE =
  "ASK CLI will create an IAM user and generate corresponding access key id and secret access key. Do not share neither of them.";
