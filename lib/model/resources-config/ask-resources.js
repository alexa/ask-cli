...
module.exports = class AskResources extends ConfigFile {
    ...
    getSkillMetaManifest(profile) {
        return this.getProperty(['profiles', profile, 'skillMetadata', 'manifest']) || CONSTANTS.FILE_PATH.SKILL_PACKAGE.MANIFEST;
    }

    setSkillMetaManifest(profile, manifest) {
        this.setProperty(['profiles', profile, 'skillMetadata', 'manifest'], manifest);
    }
